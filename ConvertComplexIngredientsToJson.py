...
llamapath = "logs/llama3.1"
qwenpath = "logs/qwen3"
complexIngredients_llama3 = fileloader.load_json_from_disk(os.path.join(llamapath,"ComplexIngredients_llama3.1.json"))
...
fileloader.store_json_on_disk(complexIngredients_llama3, os.path.join(llamapath, "ComplexIngredients_Json_llama3"))
